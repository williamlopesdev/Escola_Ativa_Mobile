...
export default function Secao2() {
    ...
    return(
        <View style={{minHeight: 480}}>
            <Text style={styles.title}>Metodologias para linguagens</Text>

            <Card style={styles.card}>
                <Card.Actions style={{flexDirection: "row-reverse", backgroundColor: "#f5f5f0"}}>
                    <Text>
                        Publicado por: <Text style={styles.author}>Mario Menezes</Text>
                    </Text>
                </Card.Actions>
                ...
                <View>
                    <View style={{alignItems: "center", width: "100%"}}>
                        <View style={{backgroundColor: "#00b300", width: "100%"}}>
                            <Text style={styles.label}>Disciplina: Linguagens</Text>
                        </View>
