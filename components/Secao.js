...
export default function Secao() {
    ...
    return(
        <View style={{minHeight: 480}}>
            <Text style={styles.title}>Metodologias para matemática</Text>

            <Card style={styles.card}>
                <Card.Actions style={{flexDirection: "row-reverse", backgroundColor: "#f5f5f0"}}>
                    <Text>
                        Publicado por: <Text style={styles.author}>Ingrid Xavier</Text>
                    </Text>
                </Card.Actions>
                ...
                <View>
                    <View style={{alignItems: "center", width: "100%"}}>
                        <View style={{backgroundColor: "#00b300", width: "100%"}}>
                            <Text style={styles.label}>Disciplina: Matemática</Text>
                        </View>

                        <View style={{backgroundColor: "#00cc00", width: "100%"}}>
                            <Text style={styles.label}>Metodologia: Gameficação</Text>
                        </View>
                    </View>
            ...
            <Card style={styles.card}>
                <Card.Actions style={{flexDirection: "row-reverse", backgroundColor: "#f5f5f0"}}>
                    <Text>
                        Publicado por: <Text style={styles.author}>William Lopes</Text>
                    </Text>
                </Card.Actions>
                ...
                <View>
                    <View style={{alignItems: "center", width: "100%"}}>
                        ...
                        <View style={{backgroundColor: "#00cc00", width: "100%"}}>
                            <Text style={styles.label}>Metodologia: Aprendizagem em dupla</Text>
                        </View>
                    </View>
